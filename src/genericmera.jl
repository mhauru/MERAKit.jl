...
"""
Layer is an abstract supertype of concrete types such as `BinaryLayer`.
"""
...
function tensorwise_scale(m::GenericMERA, alpha)
...
function precondition_tangent(m::GenericMERA, tan::GenericMERA, pars)
    nt = num_translayers(m)
